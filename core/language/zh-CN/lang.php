...
$lang = array (
	...
	'js_change_password' => '如不需要更改密码，此处请留空',
	'username_character' => '用户名3-30个字符',
	'username_will' => '姓名不能为空',
	'password_too_short' => '密码不得少于',
	'js_invitation_sensitivity' => '邀请码包含敏感字符',
	'import_organization'=>'导入机构',
	'choose_import_agency_department'=>'选择导入的机构或部门',
	// dzz/script/_fun.js
	'click_here_copy_clipboard'=>'点此复制到剪贴板',
	'copy_unsuccess_allow_access'=>'复制失败，请选择“允许访问”',
	'verification_error_reset'=>'验证码错误，请重新填写',
	'verification_question_error_reset'=>'验证问题错误，请重新填写',
	// dzz/scripts/dzz.api.js
	'Insert_nonenterprise_files_not_supported'=>'不支持非企业盘内文件插入',
	'not_choose_agencies_departments' => '未选择机构和部门',
	'not_choose_agencies_departments1' => '无机构和部门',
	...
	'login_username_tips'=>'必填，系统显示的用户姓名',
	'login_nickname_tips'=>'必填，用户在系统中的唯一标识，可用于系统登录',
	'update_success' => '更新成功',
	'confirm_add' => '确认添加',
	'simulate'=>'模拟',
	
	'theme'=>'主题',
	'theme_inexistence'=>'主题不存在',
	'theme_catalogue'=>'主题目录',
	'theme_add_success'=>'主题添加成功',
	'theme_set'=>'主题设置',
	'theme_manage'=>'主题管理',
	...
	'photo'=>'图片',
	'download_photo'=>'下载图片',
	'please_upload_cover_img'=>'请上传封面图片',
	'more_largest_number'=>'超过最大数量',
	'allow_file_type'=>'不允许的文件类型！',
	'file_too_large'=>'文件太大了！',
	'file_too_small'=>'文件太小了！',
	...
	'release_unsuccess'=>'发布失败',
	'cancle_publish'=>'取消发布',
	'cancle_publish_unsuccess'=>'取消发布成功',
	'cancle_publish_remind'=>'取消发布提醒',
	'confirm_publish'=>'确定发布',
	'confirm_publish_remind'=>'确定发布提醒',
	'event_publish' => '{username}发布了 <a href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{position}</a>',
	'event_unpublish' => '{username}取消了发布 <a href=\'javascript:;\' onclick="location.hash=\'{hash}\';">{position}</a>',
	'in_recovery'=>'恢复中...',
	'in_setting'=>'正在设置...',
	'in_remove'=>'移除中...',
	'in_clear'=>'清除中...',
	...
	'not_need'=>'不需要',
	'new_Window'=>'新窗口',
	'default_application_settings'=>'默认应用设置',
	...
	'unselect_a_organization_or_department'=>'不选择机构或部门',
	'system_administrator_export'=>'没有权限，只有系统管理员才能导出用户',
	'basic_information'=>'基本资料',
	
	'details_information'=>'详细资料',
	'users_list'=>'用户列表',
	'last_visit'=>'最后访问',
	...
	'error_occurred_written_local'=>'写入本地时出错，请检查本地存储目录是否有写入权限',
	'file_transfer_errors'=>'文件传输错误,请重试',
	'filename_already_exists'=>'文件名已存在！',
    'please_select_dir'=>'请选择目录',
	'wait'=>'等',
	'file_longer_exists'=>'文件已经不存在',
	'parent_directory_not_exist'=>'父目录不存在',
	'open_file_error'=>'打开文件错误',
	'cache_file_error'=>'缓存文件到本地出现错误，请确认目录有写入权限，并且更新系统缓存后重试',
	'cache_file_error1'=>'缓存文件到本地出现错误，请确认目录/data/attachment/cache/有写入权限，并且更新系统缓存后重试',
	'file_content_cannot_empty'=>'文件内容不能为空',
	'target_location_not_exist'=>'目标位置不存在',
	'failed_create_Dzz_document'=>'创建Dzz文档失败',
	'files_allowed_copy'=>'此类文件不允许复制',
	'written_file_correct'=>'写入文件不正确',
	'failed_get_file'=>'获取文件失败',
	'extract_wrong_password'=>'提取密码错误',
	'share_file_deleted'=>'此分享文件已删除',
	'share_file_iscancled'=>'此分享文件已取消',
	'sharefile_isdeleted_or_positionchange'=>'此分享包含文件位置被改变',
	'not_support_application'=>'不支持此应用',
	'document_only_stored_enterprise'=>'非文件类只能存储在企业盘',	
	...
	'file_not_exist1'=>'文件不存在',
	'file_save_exist'=>'文件保存错误',
	'linktoimage_error'=>'抱歉，图片添加失败！',
	'linktomusic_error'=>'抱歉，音乐添加失败！',
	'linktovideo_error'=>'抱歉，视频添加失败！',
	'linktourl_error'=>'抱歉，网址添加失败！',
	...
	'require_allocation_attain'=>'要求配置达到',
	'examine_details'=>'查看详情',
	'the_program_has_a_new_version'=>'程序有新版本',
	'Upgrade_Now'=>'现在升级',
	...
	'rename_document'=>'修改了文档名称',
	'filename_extension'=>'文件后缀',
	'prefix'=>'前缀',
	'suffix'=>'后缀',
	'limit'=>'限制',
	'no_limit'=>'不限制',
	...
	'remove_error_object_inexistence'=>'删除错误！要删除的对象已经不存在',
	'remove_error_check_the_content'=>'删除错误！请检查以下内容：此用户组下无下级用户组',
	// core/cron/cron_refresh_default_token_by_admin.php
	'baidu_network_disk_test'=>'百度网盘测试',
	'baidu_network_disk'=>'百度网盘',
	// core/template/wx_ajax.html
	'member_click_skip_link'=>'成员点击该菜单会跳到以上链接',
    ...
    'access_method_login_application_secret'=>'获取方法：［登录企业号后台］－［企业应用］－［选择需要绑定的应用］－［复制应用Secret］',
	'application_state'=>'应用状态',
	'application_state_message'=>'关闭应用后，将不在向此应用发送消息，应用的菜单事件也将没有回应',
	'need_weixin_enterprises_set'=>'以下的所有设置都需要到微信企业号内设置',
	'weixin_enterprises_edit'=>'去微信企业号修改',
	'scope_application_visible'=>'应用可见范围',
	'top_institutions'=>'顶级机构',
	'organization_not_exists'=>'机构(群组)不存在',
	'weixin_enterprises_address_book_'=>'(微信企业号内通讯录里最顶级的机构)',
	'trusted_domain_name'=>'可信域名',
	'copy_success_paste_need_place'=>'复制成功,请粘帖到您需要的地方',
	'syntony_URL_configuration_information'=>'回调URL及密钥配置信息',
	'other_configuration_information'=>'其他项配置信息',
	'internal_error_unable_display_content'=>'内部错误，无法显示此内容',
	// core/template/share_password.html
	'share_extract_password'=>'此分享设置了提取密码，请在下面输入正确的提取密码',
	'write_extract_password'=>'填写提取密码',
	'immediate_retrieval'=>'立即提取',
	// core/template/wx_menu.html
	'creat_three_level_menu'=>'可创建最多 3 个一级菜单，每个一级菜单下可创建最多 5 个二级菜单。',
	'edit_menu_in_the_user_can_not_see'=>'编辑中的菜单不会马上被用户看到，请放心调试。',
	'menu_release_24_hours_to_update'=>'菜单发布后24小时内所有用户都将更新到新的菜单',
	'level_1_menu_name_limit_beyond_truncation'=>'一级菜单名称不多于4个汉字或8个字母，超出部分自动截断。',
	'level_2_menu_name_limit_beyond_truncation'=>'二级菜单名称不多于8个汉字或16个字母，超出部分自动截断。',
	'add_second_level_of_menus'=>'添加二级菜单',
	'level_2_menu_name_limit'=>'二级菜单名称不多于8个汉字或16个字母',
	'add_themselves_menu'=>'添加一级级菜单',
	'published_weixin'=>'发布到微信',
	'restore_defaults'=>'恢复默认',
	'release_24_hours_to_update'=>'发布后24小时内所有用户都将更新到新的菜单',
	'use_the_secondary_menu'=>'使用二级菜单后，当前编辑的消息将会被清除。确定使用二级菜单?',
	'secondary_menu_confirm'=>'二级菜单确认',
	'add_the_event_type'=>'添加事件类型',
	'restore_the_default_menu'=>'确定要恢复默认菜单吗？',
	'none_response_event_please_check'=>'还有没有设置响应事件的菜单，请检查',
	// core/template/wx_mpinfo.html
	'developer_credentials_login_commonality_terrace'=>'此项是开发者凭据，您需登录［微信公共号平台］，去[开发者中心]-配置项 中获取',
	'need_developer_center_settings'=>'以下的所有设置都需要到微信公众号内开发者中心设置',
	'weixin_public_number'=>'去微信公众号',
	'server_configuration_information'=>'服务器配置信息',
	'server_address'=>'服务器地址',
	'token'=>'令牌',
	'message_encryption_key'=>'消息加解密密钥',
	'message_encryption'=>'消息加解密方式',
	'safe_mode'=>'安全模式',	
  'timezone' => '
		\'9999\' => \'使用系统默认\',
  ...
  'moderate'=>'审核',
  'need_moderate'=>'需审核',
  'no_need_moderate'=>'不需审核',
  'moderate_reasonpm'=>'操作理由',
  'moderate_explain'=>'操作说明',
...
//	'members_verify_gender_2' => '女',
	...
	'members_verify' => '认证设置',
	'members_verify_success' => '认证设置成功',
	'members_verify_save_success' => '认证设置保存成功',
	...
	'members_verify_title_empty' => '认证名称不能为空',
	'members_verify_synopsis' => '认证简介',
...
//	'delete'=>'删除',
	...
	'add_typename_attach'=>'添加文件',
	'all_typename_attach'=>'全部文件',
	'share_typename_attach'=>'分享文件',
	'share_time'=>'分享时间',
//	'type_music'=>'音乐',
	...
	'more_member_owner'=>'多成员所属',
	'more_folder_position'=>'多文件夹位置',
	'all_positioned'=>'全部位于',
	'more_file_type'=>'多文件类型',
	'undefined_file_type'=>'未知文件类型',
	'louis_vuitton'=>'均为',
	'type_of_file'=>'类型文件',
	'error_delete_version_failed'=>'错误,删除该版本失败',
	...
	'setting_mail_send_error' => '邮件发送失败！请检查您的邮箱是否正确，或者更换邮箱\n',

	
	'attachment_nonexistence'=>'文件不存在或已被删除',
	
	'id_not_exist'=>'您查看的项目不存在，或已经删除！',
	'app_not_exist'=>'应用不存在，或已经删除！',
	'folder_not_exist'=>'目录不存在，或已经删除！',
	'link_not_exist'=>'网址不存在，或已经删除！',
	'music_not_exist'=>'音乐不存在，或已经删除！',
	'video_not_exist'=>'视频不存在，或已经删除！',
	'image_not_exist'=>'图片不存在，或已经删除！',
...
//	'anonymity' => '匿名',
	...
	'profile_nickname_illegal' => '用户名不合法',
	...
	'profile_username_illegal' => '姓名不合法',
...
//	'location_login_succeed' => '',
    ...
    'org_space_set'=>'机构和群组空间设置',
    'user_space_set'=>'用户空间设置',
    'org_space_set_text'=>'注：设置机构和群组的默认空间大小，如果不设置或者为0，则不限制机构或群组的空间大小',
    'file_more_version_set'=>'文件多版本设置',
    'user_set_space'=>'用户空间',
	'user_allocable_space'=>'当前用户可分配空间大小',
...
{siteurl}',
	...
	'seccode_image_tips' => '<span class="seccode_image_tips">输入下图中的字符</span>',
	'seccode_image_ani_tips' => '<span class="seccode_image_tips">请输入下面动画图片中的字符</span>',
...
//	'login_username' => '用户名',
	...
	'login_tips' => 'oaooa 是 <a href="http://www.oaooa" target="_blank">欧奥</a>公司推出的以社区为基础的专业建站平台，帮助网站实现一站式服务。',
	...
	'password_share' => '密码分享',
	  ...
	  'invite_code' => '邀请码',
	  'login_inactive' => '放弃激活，现在<a href="user.php?mod={$_G[setting][regname]}">{$_G[setting][reglinkname]}</a>',
	  'login_now' => '已有帐号？现在登录',
	  'password_confirm' => '确认密码',
	  'affirm'=>'确认',
	  'register_buyinvitecode' => '还没有邀请码？点击此处获取',
	  'register_email_tips' => '请输入正确的邮箱地址',
	  'register_email_tips1' => '请输入邮箱地址',
	  'register_message' => '注册原因',
	  'please_register_message' => '申请注册原因',
	...
	'error_writing_temporary_file'=>'写入临时文件错误,请检查临时目录有无写入权限',
	'input_jd_acc_sec1'=>'京东云存储测试连接失败，请确认accessKey和secretKey正确，且当前京东云存储可用',
	'input_jd_acc_sec'=>'请输入京东云存储的accessKey和secretKey',
	'input_aliyun_acc_sec'=>'请输入阿里云存储的',
	'temporary_support_directory'=>'暂不支持目录功能',
	'refresh_access_token'=>'刷新access_token失败',
	'set_bucket_name_region'=>'请设置bucket名称和访问域名',
	'test_read_failure'=>'测试读取失败，请检查您设置的访问域名是否正确',
	'upload_error_not_file'=>'上传错误,未获取到上传的文件',
	'flag_purview_setting'=>'标志位为1表示权限设置,否则表示未设置，继承上级',
	'read_my_file'=>'读取自己的文件',
	'read_my_file1'=>'读取所有文件',
	'delete_my_file'=>'删除自己的文件',
	'delete_all_file'=>'删除所有文件',
	'edit_my_file'=>'编辑自己的文件',
	'edit_all_file'=>'编辑所有文件',
	'upload_my_file'=>'下载自己的文件',
	'upload_all_file'=>'下载所有文件',
	'copy_my_file'=>'复制自己的文件',
	'copy_all_file'=>'复制所有文件',
	'read_only'=>'只读',
	'read_only_state'=>'只允许成员查看由管理员添加的文件，不能上传、新建、复制、编辑、删除文件。',
	'write_only'=>'只写',
	'write_only_state'=>'只允许成员上传、新建、添加内容。成员只能查看自己添加的文件。不能编辑、删除文件。只写目录下只能创建只写目录（管理员也不例外）。',
	'upload_only'=>'仅下载',
	'upload_only_state'=>'只允许成员查看由管理员添加的文件。可以下载、拷贝文件。',
	'read_write'=>'读写',
	'read_write_state'=>'允许成员上传、新建、编辑、复制、查看、删除自己的文件，不能编辑、复制、删除其他人的文件',
	'read_write_state1'=>'允许成员上传、新建、编辑、复制、查看所有文件，但仅能删除自己的文件，不能删除其他人的文件。',
	'read_write_state2'=>'允许成员上传、新建、编辑、复制、查看所有文件，不能删除自己或其他人的文件。',
	'full_control'=>'完全控制',
	...
	'day_last'=>'天后',
	'expired'=>'已过期',
	'400_error'=>'400 Bad Request - 由于包含语法错误，当前请求无法被服务器理解',
	'401_authentication'=>'401 Unauthorized — 当前请求需要用户验证',
	'403_execute'=>'403 Forbidden — 服务器已经理解请求，但是拒绝执行它',
	'404_server'=>'404 Not Found — 请求失败，请求所希望得到的资源未被在服务器上发现',
	'405_resource'=>'405 Method Not Allowed — 请求行中指定的请求方法不能被用于请求相应的资源',
	'407_server'=>'407 Proxy Authentication Required — 客户端必须在代理服务器上进行身份验证',
	'408_timeout'=>'408 Request Timeout — 请求超时',
	'409_resource'=>'409 Conflict — 由于和被请求的资源的当前状态之间存在冲突，请求无法完成',
	'500_condition'=>'500 Internal Server Error — 因为意外情况，服务器不能完成请求',
	'501_requested'=>'501 Not Implemented — 服务器不支持请求的工具',
	'502_server'=>'502 Bad Gateway — 服务器接收到来自上游服务器的无效响应',
	'did_not_ID'=>'没有获取到 client ID',
	'did_refresh_token'=>'没有获取到refresh_token',
	'fail_file'=>'打开文件失败',
	'East China'=>'华东',
	'North China'=>'华北',
	'South China'=>'华南',
	'North America'=>'北美',
	'Southeast Asia'=>'东南亚',
	'does_mysqli'=>'不支持mysqli',
	'database_error'=>'数据库连接错误',

	'write_failure'=>'写入失败',
	'duplicate'=>'-副本',
	'no_problem'=>'无问题',
	'signature_verification'=>'签名验证错误',
	'Xml_parsing'=>'xml解析失败',
	'sha_encryption'=>'sha加密生成签名失败',
	'encodingAesKey_illegal'=>'encodingAesKey 非法',
	'Appid_validation'=>'appid 校验错误',
	'Aes_encryption'=>'aes 加密失败',
	'Aes_decryption'=>'aes 解密失败',
	'Illegal_decryption'=>'解密后得到的buffer非法',
	'Base64_encryption'=>'base64加密失败',
	'Base64_decryption'=>'base64解密失败',
	'Generate_xml'=>'生成xml失败',
	'wrong_upload'=>'文件大小错误,请重新上传',
	'successful_processing'=>'处理成功',
	'verify_failed'=>'校验签名失败',
	'parsingxml_failed'=>'解析xml失败',
	'calculated_signature'=>'计算签名失败',
	'Invalid_AESKey'=>'不合法的AESKey',
	'verify_AppID'=>'校验AppID失败',
	'AES_encryption'=>'AES加密失败',
	'AES_decryption'=>'AES解密失败',
	'xml_platform_illegal'=>'公众平台发送的xml不合法',
	'Base64_encoding_failed'=>'Base64编码失败',
	'Base64_decoding_failed'=>'Base64解码失败',
	'failed_generate_xml'=>'公众帐号生成回包xml失败',
	...
	//EXIF
	'fs_EXIF_XJXX_KMSD'=>'快门速度',
	'fs_EXIF_XJXX_FZ'=>'光圈',
	'fs_EXIF_XJXX_ISO'=>'ISO',
	'fs_EXIF_XJXX_JYDBGZS'=>'建议曝光指数',
	'fs_XEIF_XJXX_BGMS'=>'曝光模式',
	'fs_EXIF_XJXX_BGBCZ'=>'曝光补偿值',
	'fs_EXIF_XJXX_JJ'=>'焦距',
	'fs_EXIF_XJXX_SG'=>'闪光',
	'fs_EXIF_XJXX_BGSD'=>'曝光设定',
	'fs_EXIF_XJXX_BGSJ'=>'曝光时间',
	'fs_EXIF_XJXX_BPH'=>'白平衡',
	'fs_EXIF_XJXX_CHMS'=>'测光模式',
	'fs_EXIF_XJXX_JPJJ'=>'35mm胶片焦距',
	'fs_EXIF_XJXX_CJPSLX'=>'场景拍摄类型',
	'fs_EXIF_XJXX_DBD'=>'对比度',
	'fs_EXIF_XJXX_BHD'=>'饱和度',
	'fs_EXIF_XJXX_QXD'=>'清晰度',
	'fs_EXIF_XJXX_CS'=>'相机厂商',
	'fs_EXIF_XJXX_XH'=>'相机型号',
	'fs_EXIF_XJXX_XJSYZ'=>'相机所有者姓名',
	'fs_EXIF_XJXX_JSXLH'=>'机身序列号',
	'fs_EXIF_XJXX_JTGG'=>'镜头规格',
	'fs_EXIF_XJXX_JTCS'=>'镜头厂商',
	'fs_EXIF_XJXX_JDXH'=>'镜头型号',
	'fs_EXIF_XJXX_JDXLH'=>'镜头序列号',
	'fs_EXIF_XJXX_BPHXQ'=>'白平衡详情',
	'fs_EXIF_XJXX_SGBC'=>'闪光补偿',
	'fs_EXIF_TX_RJ'=>'图像软件',
	'fs_EXIF_TX_RQ'=>'拍摄时间',
	'fs_EXIF_TX_YSRQ'=>'原始时间',
	'fs_EXIF_TX_SZHRQ'=>'数字化时间',
	'fs_EXIF_TX_FX'=>'方向',
	'fs_EXIF_TX_TXMS'=>'图像描述',
	'fs_EXIF_TX_YSJ'=>'艺术家',
	'fs_EXIF_TX_BQ'=>'版权',
	'fs_EXIF_GPS_WD'=>'纬度',
	'fs_EXIF_GPS_WDCZ'=>'纬度参照',
	'fs_EXIF_GPS_JD'=>'经度',
	'fs_EXIF_GPS_JDCZ'=>'经度参照',
	'fs_EXIF_GPS_HB'=>'海拔',
	'fs_EXIF_GPS_HBCZ'=>'海拔参照',
	'fs_EXIF_GPS_SJBQ'=>'GPS时间标签',
	...
	'fs_IPTC_MSZZ'=>'描述作者',
	'fs_IPTC_GJC'=>'关键词',
	'fs_IPTC_ZTDM'=>'IPTC主题代码',
	'fs_IPTC_LB'=>'类别',
	'fs_IPTC_BCLB'=>'补充类别',
	'fs_IPTC_LXR_CJZ'=>'创建者',
	'fs_IPTC_LXR_ZW'=>'职务',
	'fs_IPTC_LXR_CS'=>'城市',
	'fs_IPTC_LXR_S'=>'省/自治区/直辖市',
	'fs_IPTC_LXR_YZBM'=>'邮政编码',
	'fs_IPTC_LXR_GJ'=>'国家/地区',
	'fs_IPTC_LXR_DH'=>'电话',
	'fs_IPTC_LXR_DZYJ'=>'电子邮件',
	'fs_IPTC_LXR_URL'=>'网站地址',
	'fs_IPTC_BQ_BQSM'=>'版权声明',
	'fs_IPTC_BQ_BQBSF'=>'版权标识符',
	'fs_IPTC_BQ_SYZMC'=>'版权所有者名称',
	'fs_IPTC_BQ_QLSYTK'=>'权利使用条款',
	'fs_IPTC_TX_CJRQ'=>'创建日期',
	'fs_IPTC_TX_ZSLX'=>'知识类型',
	'fs_IPTC_TX_CJDM'=>'IPTC场景代码',
	'fs_IPTC_TX_WZ'=>'位置',
	'fs_IPTC_TX_CS'=>'城市',
	'fs_IPTC_TX_S'=>'省/自治区/直辖市',
	'fs_IPTC_TX_GJ'=>'国家/地区',
	'fs_IPTC_TX_DQDM'=>'国家/地区代码',
	'fs_IPTC_ZT_ZYBSF'=>'作业标识符',
	'fs_IPTC_ZT_SM'=>'说明',
	'fs_IPTC_ZT_LY'=>'来源',
	'fs_IPTC_ZT_MX'=>'鸣谢',
	'fs_IPTC_ZT_JJCD'=>'紧急程度',
	'fs_IPTC_ZT_FBRQ'=>'发布日期/时间',
	'fs_IPTC_ZT_BJZT'=>'编辑状态',
	'fs_IPTC_ZT_DXZQ'=>'对象周期',
	'fs_IPTC_ZT_GDBS'=>'固定标识',
	'fs_IPTC_ZT_YSCX'=>'原始程序',
	'fs_IPTC_LXR_DZ'=>'地址',
	
	//视频
	
	'fs_shipin_fps'=>'FPS',
	'fs_shipin_fenbianlv'=>'分辨率',
	'fs_shipin_shichang'=>'时长',
	'fs_shipin_paisheshijian'=>'拍摄时间',
	'shipin_kuandu'=>'视频宽度',
	'fs_shipin_gaodu'=>'视频高度',
	'fs_shipin_malv'=>'码率（比特率）',
	
	//音频
	'fs_yinpin_bpm'=>'速度(BPM)',
	'fs_yinpin_shichang'=>'时长',
	'fs_yinpin_caiyanglv'=>'音频采样率',
	'fs_yinpin_yangbenleixing'=>'音频样本类型',
	'fs_yinpin_dongdao'=>'通道',
	'fs_yinpin_yishujia'=>'艺术家',
	'fs_yinpin_changpian'=>'唱片',
	'fs_yinpin_qumubianhao'=>'曲目编号',
	'fs_yinpin_liupai'=>'流派',
	'fs_yinpin_zuoqujia'=>'作曲家',
	'fs_yinpin_fxrq'=>'发行日期',
	'fs_yinpin_yueqi'=>'乐器',
	...
	'fs_S_archive'=>'归档状态',
	'fs_S_creator'=>'创建者',
	'fs_S_create_time'=>'创建时间',
	
	
	
	'file_down_checking'=>'数据校验中',
	'file_down_geting'=>'文件获取中',
	'file_pakaging'=>'文件打包中',
	'file_down_preparing'=>'文件准备中',
	...
	'submit_success'=>'提交成功',
	'classify'=>'分类',
	'classify_management'=>'分类管理',
	'classify_name'=>'分类名称',
	'Classification_cannot_modified'=>'分类不能修改',
	'unclassify'=>'未分类',
	'search' => '搜索',
	'name'=>'名称',
	'Name_duplication'=>'名称重复',
	'file_name'=>'文件名称',
	'input_name'=>'输入名称',
	'Please_input_name'=>'请输入名称',
	'name_cannot_empty'=>'名称不能为空',
	'name_cannot_repeat'=>'名称不能重复',
	'download'=>'下载',
    'file_size'=>'文件大小',
	'confirms'=>'确定',
	'cancel'=>'取消',
	...
	'all_completed'=>'已经到底了',
	'all_completed1'=>'到底了，可能会有部分文件因权限未显示',
	'co_query'=>'共查询',
	'newly_created'=>'最新创建',
	'recent_updates'=>'最近更新',
    ...
    'share_edit'=>'分享编辑',
    'share_create'=>'创建分享',
    'share_delete_success'=>'删除成功！',
    'share_delete_confirm'=>'删除分享后，分享链接将不可用，确定要删除此分享吗？',
	...
	'Filter_settings'=>'筛选器设置',
	'theme_color'=>'切换页面配色',
	'rename'=>'重命名',
	'Create_peer'=>'新建同级',
	'Create_Child'=>'新建子级',
	'Unnamed_classification'=>'未命名分类',
	'Unnamed'=>'未命名',
	'import'=>'导入',
	'import_type_app'=>'导入应用',
	'import_data'=>'导入数据',
	'import_failure'=>'导入失败',
	'start_import'=>'开始导入',
	'continue_import'=>'继续导入',
	'import_click_stop'=>'导入中,点击停止',
	'import_set'=>'导入设置',
	'in_import'=>'导入中...',
	'choose_import_way'=>'选择导入方式',
	'import_way'=>'导入方式',
	'import_finish'=>'导入完成',
	'import_success'=>'导入成功',
	'all_import'=>'全部导入',	
	'export'=>'导出',
	'select_all_export'=>'全选导出',
	'all_export'=>'全部导出',
	'export_data'=>'导出数据',
    ...
    'qrcode_image_tip'=>'手机扫码,查看链接',

    'copy_link'=>'复制链接',
    'loading'=>'加载中...',
    'system_info'=>'系统信息',
    'library_manage'=>'库管理',
    'tabgroup_setting'=>'专辑设置',
    'page_manage'=>'单页管理',
    'banner_manage'=>'栏目管理',
	'web_upload'=>'本地上传',
    'setting'=>'设置',

    'elongated_horizontal_chart'=>'细长横图',
    'elongated_vertical_view'=>'细长竖图',
    'square_diagram'=>'方图',
    'horizontal_chart'=>'横图',
    'portrait_view'=>'竖图',

	'no_institution_users'=>'无机构用户',
	'no_institution_users1'=>'无组用户',
	'institution_users'=>'机构用户',
	'move'=>'移动',
	'Move_in'=>'移入',
	'move_success'=>'移动成功',
	'move_file'=>'移动文件',
	...
	'locking'=>'锁定',
	'Unlock'=>'解锁',
	'Edit_information_cover'=>'编辑信息和封面',
    'ai_tag_template_end'=>'。返回结果的格式为“标签1,标签2,标签3”，其中标签之间使用逗号分割。',
	'download_all'=>'下载全部',
    'search_picture'=>'搜相似图',
	'similarity'=>'相似度',
