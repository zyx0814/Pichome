...
const Tmpquestion_txt = {
    ...
    template:`
        <div ref="DomDiv">
            <div class="question-box" v-for="(item,key) in model.data" :key="item.key">
                ...
                <div class="question-row">
                    ...
                    <div class="title-col" style="align-items: start;">答案：</div>
                    <div class="input-col">
                        <Tmpquestion_wangEditor :model="item"></Tmpquestion_wangEditor>
        ...
        <el-button plain text style="width: 100%;border-top: var(--el-border);border-bottom: var(--el-border);border-radius: 0;" @click="handleadd" icon="plus">添加</el-button>
    `,
    setup(props,context){
        // <el-input v-model="item.answer" :rows="2" type="textarea"></el-input>
        let DomDiv = ref(null);
        ...
        <div ref="DomdragTab">
            <el-tabs
                ...
                <el-tab-pane
                    ...
                    <Tmpquestion_txt :model="item" :field=field></Tmpquestion_txt>
                </el-tab-pane>
            </el-tabs>
        </div>
