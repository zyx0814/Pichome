...
`storage`  mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
...
`appico`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`appdesc`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`appurl`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`appadminurl`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '管理设置地址' ,
`noticeurl`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '通知接口地址' ,
`dateline`  int(10) UNSIGNED NOT NULL ,
`disp`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`vendor`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '提供商' ,
...
`feature`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '窗体feature' ,
`fileext`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '可以打开的文件类型' ,
...
`identifier`  varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`app_path`  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'APP路劲' ,
`available`  tinyint(1) NOT NULL DEFAULT 1 ,
`version`  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`upgrade_version`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '升级版本' ,
...
`uids`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '访问用户' ,
...
`ext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`tagname`  char(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' ,
`dateline`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
PRIMARY KEY (`tagid`),
...
`aid`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`filename`  char(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`area`  char(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`filename`  char(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`filetype`  char(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`filesize`  bigint(20) UNSIGNED NOT NULL DEFAULT 0 ,
`attachment`  char(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`cachekey`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`ourl`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`type`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'pan,mail,storage,web' ,
`bz`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'Dropbox,Box,Google,Aliyun,Grandcloud' ,
...
`dname`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '数据库名称' ,
`curl`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '授权地址' ,
`disp`  smallint(6) NOT NULL DEFAULT 0 ,
...
`id`  int(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
`cloudname`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`attachdir`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '绝对位置' ,
`attachurl`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '访问地址（选填）' ,
`uid`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`perm`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`bz`  varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'DISK' ,
`dateline`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`charset`  varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'GBK' ,
PRIMARY KEY (`id`)
)ENGINE=MyISAM;
...
`uid`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`perm`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`bz`  varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'FTP' ,
`dateline`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
...
`id`  int(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
`bz`  varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`cloudname`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`cuid`  char(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`cusername`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`portrait`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`uid`  int(10) UNSIGNED NOT NULL ,
`expires_in`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`dateline`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`refreshtime`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
...
`session_secret`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
PRIMARY KEY (`id`),
...
`bucket`  char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`bz`  varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`hostname`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`internalhostname`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`host`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`internalhost`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`extra`  varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
PRIMARY KEY (`id`)
)ENGINE=MyISAM;
-- ----------------------------
...
`type`  enum('user','system','app') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'user' ,
`name`  char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`filename`  char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`lastrun`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`nextrun`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`weekday`  tinyint(1) NOT NULL DEFAULT 0 ,
`day`  tinyint(2) NOT NULL DEFAULT 0 ,
`hour`  tinyint(2) NOT NULL DEFAULT 0 ,
`minute`  char(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
PRIMARY KEY (`cronid`),
...
`action`  char(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`uid`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`username`  char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`dateline`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
PRIMARY KEY (`eid`),
...
`version`  smallint(6) UNSIGNED NOT NULL DEFAULT 0 ,
`attachs`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
PRIMARY KEY (`revid`),
KEY `dateline` (`dateline`) USING BTREE ,
...
`username`  char(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`addons`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '钩子对应程序' ,
...
`reg`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '匹配正则表达式' ,
`ext`  varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`disp`  smallint(6) UNSIGNED NOT NULL DEFAULT 0 ,
`cssname`  varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
PRIMARY KEY (`id`),
...
`type`  enum('smiley','icon','avatar') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'smiley' ,
`displayorder`  tinyint(3) NOT NULL DEFAULT 0 ,
`directory`  char(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
PRIMARY KEY (`typeid`)
)ENGINE=MyISAM;
...
`router`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`dateline`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`available`  tinyint(1) NOT NULL DEFAULT 0 ,
...
`id`  int(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
`uid`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`type`  varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`wx_note`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
...
`from_idtype`  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`orgname`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`pathkey`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`type`  int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0一般机构，1群组机构' ,
`desc`  varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '群组描述' ,
`groupback`  int(11) UNSIGNED NOT NULL COMMENT '群组背景图' ,
`aid`  varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '群组缩略图,可以是aid,也可以是颜色值' ,
...
`ext`  char(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '文件类型' ,
...
`appid`  char(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '库id' ,
PRIMARY KEY (`rid`),
...
`fid`  char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '目录id' ,
`pfid`  char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '父级目录id' ,
`fname`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '目录名称' ,
`appid`  char(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '对应库id' ,
`perm`  int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '权限值' ,
`pathkey`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '路径关系' ,
`dateline`  int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间' ,
`cover`  char(13) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '封面，文件rid' ,
`password`  char(4) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '密码' ,
`passwordtips`  varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '密码提示' ,
...
`rid`  char(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '文件id' ,
`fid`  char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '目录id' ,
`appid`  char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '库id' ,
PRIMARY KEY (`id`),
KEY `rid` (`rid`) USING BTREE ,
KEY `fid` (`fid`) USING BTREE ,
...
`rid`  char(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '文件rid' ,
`ext`  char(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '类型' ,
...
`rid`  char(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '文件主键id' ,
`uid`  int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '用户id' ,
`username`  char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户名' ,
`appid`  char(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '库id' ,
`name`  char(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '文件名称' ,
`type`  char(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '文件类型' ,
`ext`  char(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '文件后缀' ,
...
`md5`  char(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '文件md5值' ,
...
`rid`  char(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '文件id' ,
`appid`  char(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '应用id' ,
`shape`  char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '图片形状' ,
`gray`  tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否黑白色' ,
`colors`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '颜色值' ,
...
`tag`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标签id' ,
`path`  blob NOT NULL COMMENT '路径' ,
`isget`  tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否已获取数据' ,
`searchval`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '关键词' ,
PRIMARY KEY (`rid`),
KEY `appid` (`appid`) USING BTREE ,
...
`id`  int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id' ,
`title`  varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '分享标题' ,
`filepath`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '路径' ,
`appid`  char(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'appid' ,
...
`username`  char(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户名' ,
`uid`  int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '用户名' ,
`password`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '留空无密码' ,
...
`tagname`  varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '标签名称' ,
...
`cid`  char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键id' ,
`catname`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '分类名称' ,
`pcid`  char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '父级分类id' ,
`appid`  char(13) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '应用id' ,
`dateline`  char(13) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '最后修改时间' ,
PRIMARY KEY (`cid`),
...
`tid`  int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '标签id' ,
`cid`  char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '分类id' ,
`appid`  char(13) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '库id' ,
PRIMARY KEY (`id`),
...
`uid`  int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '用户id' ,
`username`  char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户名' ,
`appname`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`personal`  tinyint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '0公开，1私有' ,
`path`  blob NOT NULL COMMENT '对应目录路径' ,
`dateline`  int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间' ,
`extra`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '拓展数据' ,
...
`notallowext`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '不允许后缀' ,
...
`processid`  char(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
...
`sid`  char(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`skey`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`svalue`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
PRIMARY KEY (`skey`)
)ENGINE=MyISAM;
...
`id`  smallint(6) UNSIGNED NOT NULL AUTO_INCREMENT ,
`name`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`folder`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'window_jd' ,
`backimg`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
...
`vendor`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`version`  varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '1.0' ,
PRIMARY KEY (`id`),
KEY `disp` (`disp`) USING BTREE
)ENGINE=MyISAM;
...
`email`  char(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`phone`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`weixinid`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '微信号' ,
`wechat_userid`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`wechat_status`  tinyint(1) NOT NULL DEFAULT 4 COMMENT '1:已关注；2：已冻结；4：未关注' ,
`nickname`  char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`username`  char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户名' ,
...
`emailsenddate`  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' ,
...
`language`  varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'zh-cn' COMMENT '语言' ,
...
`salt`  char(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`authstr`  char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`newprompt`  smallint(6) UNSIGNED NOT NULL DEFAULT 0 COMMENT '消息数' ,
`timeoffset`  char(4) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '9999' ,
...
`uid`  int(10) UNSIGNED NOT NULL ,
`docklist`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`screenlist`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`applist`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`noticebanlist`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
...
`taskbar`  enum('bottom','left','top','right') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'bottom' ,
`dateline`  int(10) UNSIGNED NOT NULL ,
`updatetime`  int(10) UNSIGNED NOT NULL ,
`attachextensions`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '-1' ,
...
`wins`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`perm`  int(10) NOT NULL DEFAULT 0 ,
`privacy`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
...
`uid`  int(10) UNSIGNED NOT NULL ,
`fieldid`  varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`fieldid`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`available`  tinyint(1) NOT NULL DEFAULT 0 ,
`invisible`  tinyint(1) NOT NULL DEFAULT 0 ,
...
`formtype`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'text' ,
`size`  smallint(6) UNSIGNED NOT NULL DEFAULT 0 ,
`choices`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`privacy`  smallint(3) NOT NULL DEFAULT 0 COMMENT '资料权限' ,
`validate`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
...
`skey`  varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户设置选项键' ,
`svalue`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '用户设置值' ,
PRIMARY KEY (`id`),
...
`uid`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`custom_backimg`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`custom_url`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`custom_btype`  tinyint(1) UNSIGNED NOT NULL ,
`custom_color`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`field`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
`orgid`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`dateline`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
PRIMARY KEY (`vid`),
...
`uid`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
`openid`  char(28) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`appid`  char(18) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`unionid`  char(29) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
`dateline`  int(10) UNSIGNED NOT NULL DEFAULT 0 ,
UNIQUE KEY `uid` (`uid`) USING BTREE ,
...
`type`  enum('system','special','member') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'member' ,
`system`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'private' ,
`grouptitle`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ,
...
`attachextensions`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
