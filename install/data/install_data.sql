...
(12, 0, '星火图片理解', 'appico/202404/29/095905euqa4ujagqqttlu1.png', '', '{dzzscript}?mod=aiXhimage', '{dzzscript}?mod=aiXhimage&op=setting', '', 0, 0, '', 0, 1, 0, 1, '', '', 3, 0, 0, 0, 0, 0, 0, 'aiXhimage', 'dzz', 1, '1.0', '', 0, 'a:1:{s:11:\"installfile\";s:11:\"install.php\";}', '', 1);
...
(4, 1, 'system', '定时获取转换状态', 'cron_pichome_getconvertstatus.php', 1714468874, 1714469100, -1, -1, -1, '0 5	10	15	20	25	30	35	40	45	50	55'),
(5, 1, 'system', '定时更新热搜', 'cron_cache_pichome_searchhot.php', 1714468935, 1714469100, -1, -1, -1, '0 5	10	15	20	25	30	35	40	45	50	55'),
(6, 1, 'system', '定时获取缩略图', 'cron_pichome_getthumb.php', 1714468996, 1714469100, -1, -1, -1, '0	5	10	15	20	25	30	35	40	45	50	55'),
(7, 1, 'system', '定时获取信息', 'cron_pichome_getinfo.php', 1714468501, 1714468800, -1, -1, -1, '0 5	10	15	20	25	30	35	40	45	50	55'),
(8, 1, 'system', '定时转换音视频', 'cron_pichome_convert.php', 1714468502, 1714468800, -1, -1, -1, '0	5	10	15	20	25	30	35	40	45	50	55'),
(10, 1, 'system', '定时获取需要更新的库', 'cron_pichome_vapp_update.php', 1714468508, 1714468800, -1, -1, -1, '0	5	10	15	20	25	30	35	40	45	50	55'),
(11, 1, 'system', '定时检查库更新过程任务', 'cron_vapp_vappdoupdate.php', 1714468569, 1714468800, -1, -1, -1, '0	5	10	15	20	25	30	35	40	45	50	55'),
(12, 1, 'system', '定时检查缩略图更新任务', 'cron_thumbcheckchange.php', 1714468630, 1714468800, -1, -1, -1, '0	5	10	15	20	25	30	35	40	45	50	55'),
(13, 1, 'system', '定时更新缩略图变动任务', 'cron_thumbdochange.php', 1714468691, 1714468800, -1, -1, -1, '0	5	10	15	20	25	30	35	40	45	50	55'),
(14, 1, 'system', '定时检查单页缓存数据更新', 'cron_update_alonepagedata.php', 1714468752, 1714468800, -1, -1, -1, '0	5	10	15	20	25	30	35	40	45	50	55'),
(19, 1, 'user', '定时执行删除库已彻底删除文件任务', 'cron_pichome_deletefile.php', 1714468461, 1714468500, -1, -1, -1, '0	5	10	15	20	25	30	35	40	45	50	55'),
(20, 1, 'system', '定时执行ai批量处理到任务表', 'cron_ai_checkaicrontotask.php', 1714468447, 1714468500, -1, -1, -1, '0	5	10	15	20	25	30	35	40	45	50	55'),
(21, 1, 'system', '定时执行ai批量处理', 'cron_ai_doaitask.php', 1714469057, 1714469100, -1, -1, -1, '0	5	10	15	20	25	30	35	40	45	50	55'),
(22, 1, 'system', '定时获取预览图缩略图任务', 'cron_pichome_getpreviewthumb.php', 1714469179, 1714469400, -1, -1, -1, '0	5	10	15	20	25	30	35	40	45	50	55'),
(23, 1, 'system', '定时检查预览图缩略图任务', 'cron_thumbcheckpreviewchange.php', 1714469240, 1714469400, -1, -1, -1, '0	5	10	15	20	25	30	35	40	45	50	55'),
(24, 1, 'system', '定时改变预览图缩略图任务', 'cron_thumbdopreviewchange.php', 1714469301, 1714469400, -1, -1, -1, '0	5	10	15	20	25	30	35	40	45	50	55');
...
(56, 12, 'editfilefilter', 'ImageAIkey', 1, 0, 'dzz\\aiXhimage\\classes\\ImageAIkey', 1, 0),
(57, 12, 'imageAiData', 'ImagetagAnddesc', 1, 0, 'dzz\\aiXhimage\\classes\\ImagetagAnddesc', 1, 0),
(58, 12, 'finalydelete', 'finalydelete', 1, 0, 'dzz\\aiXhimage\\classes\\attachmentDelAfter', 1, 0),
(59, 12, 'pichomedatadeleteafter', 'pichomedatadeleteafter', 1, 0, 'dzz\\aiXhimage\\classes\\pichomedatadeleteafter', 1, 0),
(60, 12, 'statsTokenuse', 'pichomedatadeleteafter', 1, 0, 'dzz\\stats\\classes\\addTokenuse', 1, 0);
...
INSERT INTO `dzz_setting` VALUES('maxChunkSize', '1992294');
