...
(53, 0, 'pichomedatadeleteafter', '删除库文件时清除ai记录', 1, 0, 'dzz\\aiXhimage\\classes\\pichomedatadeleteafter', 1, 0),
(54, 0, 'finalydelete', '删除附件表时清除对应ai记录', 1, 0, 'dzz\\aiXhimage\\classes\\attachmentDelAfter', 1, 0),
(55, 0, 'statsTokenuse', '统计token消耗', 1, 0, 'dzz\\stats\\classes\\addTokenuse', 1, 0),
(56, 0, 'editfilefilter', '编辑文件数据过滤', 1, 0, 'dzz\\aiXhimage\\classes\\ImageAIkey', 1, 0),
(57, 0, 'imageAiData', 'ai获取图片标签和描述', 1, 0, 'dzz\\aiXhimage\\classes\\ImagetagAnddesc', 1, 0),
(58, 0, 'pichomedatadeleteafter', '删除库文件时清除ai记录', 1, 0, 'dzz\\ollama\\classes\\pichomedatadeleteafter', 1, 0),
(59, 0, 'finalydelete', '删除附件表时清除对应ai记录', 1, 0, 'dzz\\ollama\\classes\\attachmentDelAfter', 1, 0),
(60, 0, 'editfilefilter', '编辑文件数据过滤', 1, 0, 'dzz\\ollama\\classes\\ImageAIkey', 1, 0),
(61, 0, 'imageAiData', 'ai获取图片标签和描述', 1, 0, 'dzz\\ollama\\classes\\ImagetagAnddesc', 1, 0),
