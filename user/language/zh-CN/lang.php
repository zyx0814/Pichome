...
$lang=array (
  ...
  'language' => '语言',
  'language_auto'=>'自动',
  'language_auto_tips'=>'自动选择会根据您的浏览器语言自动选择，如未找到匹配的语言则使用默认语言',
  ...
  'sure_find' => '确定找回',
  'back_login' => '返回登录',
  'lostpassword_tip'=>'通过登录邮箱找回',
  'lostpassword_email'=>'通过邮件找回',
  'lostpassword_sms'=>'通过短信找回',
  ...
  'system_busy'=>'系统繁忙!',
  'verify_email_tips'=>'<p>验证邮件24小时内有效，请尽快验证。</p><p>邮件可能会进入推广邮件或垃圾邮件中，请注意查收。</p>',
   'sending_wait'=>'发送中，请稍后...',
	'myCountCenter'=>'个人中心',
	'register_welcome_tip'=>'欢迎注册',
	'my_operation_record' => '操作记录',
	//密码安全修改密码
	'safe_verification_method'=>'验证方式',
	'safe_verification'=>'验证',
	'safe_verification_phonechk_code'=>'短信验证码',
	'safe_verification_get_code'=>'获取短信验证码',
	'send_validation_mail'=>'发送验证邮件',
	'verification_mail'=>'验证邮件',
	'verification_mail_send'=>'验证邮件已发送',
	'verification_mail_send_to_mail'=>'验证邮件已发送到您的邮箱',
	'verification_mail_tip'=>'点击邮箱内链接完成验证操作。',
	'verification_mail_expire'=>'验证邮件有效期为24小时，请尽快完成验证',
	'verification_mail_trash'=>'邮件可能会进入推广邮件或垃圾邮件中，请注意查收。',
	'verification_mail_send_again'=>'重新发送',
	'enter_my_mailbox'=>'进入邮箱',
	'been_send'=>'已发送',
	'after_secend'=>'秒',
	'sending_waiting'=>'发送中，请稍后...',
	'user'=>'用户',
	'try_log'=>'尝试登录',
	'error'=>'错误',
	'demo_login'=>'演示用户自动登录',
	'please_login'=>'请选择下列用户登录',
	'time'=>'时间',
	'Log'=>'日志',
	'sms_code_illegal'=>'短信验证码错误',
	'sms_code'=>'短信验证码',
	'sms_phone'=>'绑定手机号码',
	'sms_sended'=>'验证码已发送',
	'sms_send'=>'发送验证码',
	'sms_send_repeat'=>'再次发送',
	'sms_code_timeout'=>'验证码已过期',
   ...
   'please_tree_edit_password' => '请在 3 天之内修改您的密码',
    ...
    'avatar'=>'头像',
    'email_input'=>'邮箱',
    'email_input_msg'=>'用于登录',
    'nickname_input_msg'=>'用于登录，站点中不显示',
    'username_input_msg'=>'用户界面中显示，不能用于登录',
