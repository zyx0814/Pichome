...
(
	...
	'mail'=>'邮件设置',
	'login_username_placeholder'=>'用户姓名',
	'login_nickname_placeholder'=>'登录用户名',
	'login_username_text'=>'必填，用户姓名',
	'login_nickname_text'=>'必填，可用于系统登录',
...
//	'db_export_custom_select_all' => '全选',
	...
	'db_import_tips' => '<li>本功能在恢复备份数据的同时，将全部覆盖原有数据，请确定恢复前已将程序关闭，恢复全部完成后可以将程序重新开放。</li><li>恢复数据前请<a href="http://down.oaooa.com/restore.zip">下载恢复文件</a> 解压并找到 restore.php 文件，然后将 restore.php 文件上传到程序文件夹data目录下。<b style="color:red">为了您站点的安全，成功恢复数据后请务必及时删除 restore.php 文件。</b></li><li>您可以在数据备份记录处查看站点的备份文件的详细信息，删除过期的备份,并导入需要的备份。</li>',
...
//	'misc_cron_day' => '日',
	...
	'app_edit_support'=>'支持编辑',
	'app_edit_support_text'=>'标记此应用是否支持编辑功能',
	'support'=>'支持',
	'notsupport'=>'不支持',
	...
	'oauth_Minio_add'=>'添加Minio云存储',
	'oauth_Minio_storage'=>'Minio云存储',
	'oauth_Minio_bucket'=>'填写Minio云存储的 bucket',
	'oauth_Minio_endpoint'=>'Minio地址',
	'oauth_Minio_endpoint_tip'=>'Minio云存储 endpoint 地址',
	// admin/cloud/template/auth_qcos.html
    'oauth_QCOS_add_ALY'=>'添加腾讯云存储',
    'oauth_QCOS_ALY_storage'=>'腾讯云云存储',
    'oauth_QCOS_ALY_storage'=>'腾讯云云存储',
    'oauth_QCOS_click_gain'=>'bucket名称',
    'oauth_QCOS_bucket'=>'输入bucket名称',
    'region'=>'填写存储桶地域',
    'oauth_QCOS_host'=>'访问域名',
    'oauth_QCOS_host_tip'=>'请输入存储桶访问域名',
	...
	'edit_type_dzzoffice'=>'为oaooa PicHome提供各种功能的应用',
	'edit_type_dzzoffice1'=>'为oaooa PicHome提供各种主题和风格',
	'edit_type_dzzoffice2'=>'为oaooa PicHome提供各种扩展和功能增强',
	...
	'main_dzzoffice'=>'网址域名：如（oaooa.com,cs.oaooa.com等,通常不需要填写www前缀）',
	...
	'adduser_userrole'=>'用户角色',
	'adduser_userrole_text'=>'选择用户角色，可以多选',
...
<li>8、若需导入的人员较多，建议先做一个少量人员的测试表，测试无误后，再使用增量方式导入所有用户。</li>',
	...
	'CorpID'=>'此项是开发者凭据，您需登录［微信企业号平台］，去[设置]-［权限管理］-[管理]-[选择需要与oaooa PicHome平台绑定的管理组]，下拉至底部复制CorpID的值',
	'CorpSecret'=>'此项是开发者凭据，您需登录［微信企业号平台］，去[设置]-［权限管理］-[管理]-[选择需要与oaooa PicHome平台绑定的管理组]，下拉至底部复制Secret的值',
	'locking_range'=>'同步范围',
...
//	'nav_logs' => '运行记录',
	...
	'upgrade_right_now' => '您目前使用的 oaooa PicHome 程序有新版本发布，请及时升级<span>在线升级</span>',
	...
	'upgrade_continue_db'=> '<p>您上次升级到 <b>{steplang}</b>，请继续完成升级<p><p><input type="button" class="btn btn-success" onclick="createIframe(\'{stepurl}\')" value="继续升级">&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="btn btn-default" onclick="window.location.href=\'{recheckurl}\'" value="重新检测" /></p>',
 	...
 	'upgrade_backuping' => '正在备份原始文件... {upgradeurl}',
  	...
  	'upgrade_successful' => '恭喜您，升级成功! <br />您当前的版本为：[oaooa PicHome {version}] <br /><br />为安全起见，升级文件已保存至{save_update_dir}目录，<br />备份文件已保存至{save_back_dir}目录 {upgradeurl}',
	...
	'thumbset'=>'缩略图设置',
	'watermark'=>'水印',
	'thumb_and_watermark'=>'缩略图和水印',
	
	'image_lib' => '图片处理库类型',
	'image_lib_tips' => '请选择用来处理缩略图和水印的图像处理库。GD 是最广泛的处理库但是使用的系统资源较多。ImageMagick 速度快系统资源占用少，但需要服务器安装 ImageMagick 扩展。如果您的服务器有条件安装此程序，请到 <a href="http://www.imagemagick.org" target="_blank">http://www.imagemagick.org</a> 下载',
	
	'image_thumbquality' => '缩略图质量',
	'image_thumbquality_tips' => '设置图片附件缩略图的质量参数，范围为 0～100 的整数，数值越大结果图片效果越好，但尺寸也越大',
	'imgwater_image_watermarkstatus' => '水印设置',
	'imgwater_image_watermarkstatus_none' => '不启用水印功能',
	'imgwater_image_watermarkstatus_tips' => '您可以设置自动为 JPG/PNG/GIF 图片附件添加水印，请在此选择水印添加的位置(3x3 共 9 个位置可选)。不支持动画 GIF 格式',
	'imgwater_image_watermarkminwidthheight' => '水印添加条件',
	'imgwater_image_watermarkminwidthheight_tips' => '设置水印添加的条件，小于此尺寸的图片附件将不添加水印',
	'imgwater_image_watermarktype' => '水印图片类型',
	'imgwater_image_watermarktype_tips' => '如果设置 GIF 类型的文件作为水印，水印图片为 static/image/common/watermark.gif，如果设置 PNG 类型的文件作为水印，水印图片为 static/image/common/watermark.png，您可替换水印文件以实现不同的水印效果。如果设置文本类型的水印并且使用 GD 图片处理库，那么还需要 FreeType 库支持才能使用',
	'imgwater_image_watermarktype_gif' => 'GIF 类型水印',
	'imgwater_image_watermarktype_png' => 'PNG 类型水印',
	'imgwater_image_watermarktype_text' => '文本类型水印',
	'imgwater_image_watermarktrans' => '水印融合度',
	'imgwater_image_watermarktrans_tips' => '设置 GIF 类型水印图片与原始图片的融合度，范围为 1～100 的整数，数值越大水印图片透明度越低。PNG 类型水印本身具有真彩透明效果，无须此设置。本功能需要开启水印功能后才有效',
	'imgwater_image_watermarkquality' => 'JPEG 水印质量',
	'imgwater_image_watermarkquality_tips' => '设置 JPEG 类型的图片附件添加水印后的质量参数，范围为 0～100 的整数，数值越大结果图片效果越好，但尺寸也越大。本功能需要开启水印功能后才有效',
	'imgwater_image_watermarktext_text' => '文本水印文字',
	'imgwater_image_watermarktext_text_tips' => '如果您指定的 TrueType 字体为中文字体文件，那么您可以在文本水印中书写中文',
	'imgwater_image_watermarktext_fontpath' => '文本水印 TrueType 字体文件名',
	'imgwater_image_watermarktext_fontpath_tips' => '填写存放在 static/image/seccode/font/ch/ 或 static/image/seccode/font/en/ 目录下的 TTF 字体文件，支持中文字体。如使用中文 TTF 字体请使用包含完整中文汉字的字体文件',
	'imgwater_image_watermarktext_size' => '文本水印字体大小',
	'imgwater_image_watermarktext_size_tips' => '设置文本水印字体大小，请按照字体设置相应的大小',
	'imgwater_image_watermarktext_angle' => '文本水印显示角度',
	'imgwater_image_watermarktext_angle_tips' => '0 度为从左向右阅读文本',
	'imgwater_image_watermarktext_color' => '文本水印字体颜色',
	'imgwater_image_watermarktext_color_tips' => '输入 16 进制颜色代表文本水印字体颜色。最后两位代表透明度，值范围：00~7F,其值越大透明度越大',
	'imgwater_image_watermarktext_shadowx' => '文本水印阴影横向偏移量',
	'imgwater_image_watermarktext_shadowx_tips' => '设置文本水印阴影横向偏移量，此数值不宜设置的太大',
	'imgwater_image_watermarktext_shadowy' => '文本水印阴影纵向偏移量',
	'imgwater_image_watermarktext_shadowy_tips' => '设置文本水印阴影纵向偏移量，此数值不宜设置的太大',
	'imgwater_image_watermarktext_shadowcolor' => '文本水印阴影颜色',
	'imgwater_image_watermarktext_shadowcolor_tips' => '输入 16 进制颜色代表文本水印阴影字体颜色。最后两位代表透明度，值范围：00~7F,其值越大透明度越大',
	'imgwater_image_watermarktext_icolor' => '文本水印字体颜色(ImageMagick)',
	'imgwater_image_watermarktext_icolor_tips' => '输入 16 进制颜色代表文本水印字体颜色。最后两位代表透明度，值范围：00~64,其值越大透明度越小',
	'imgwater_image_watermarktext_shadowicolor' => '文本水印阴影颜色(ImageMagick)',
	'imgwater_image_watermarktext_shadowicolor_tips' => '输入 16 进制颜色代表文本水印阴影字体颜色。最后两位代表透明度，值范围：00~64,其值越大透明度越小',
	'imgwater_image_watermarktext_imtranslatex' => '文本水印横向偏移量(ImageMagick)',
	'imgwater_image_watermarktext_imtranslatex_tips' => '设置水印文本输出后向屏幕中央的横向的偏移值。本设置只适用于 ImageMagick 图片处理库',
	'imgwater_image_watermarktext_imtranslatey' => '文本水印纵向偏移量(ImageMagick)',
	'imgwater_image_watermarktext_imtranslatey_tips' => '设置水印文本输出后向屏幕中央的纵向的偏移值。本设置只适用于 ImageMagick 图片处理库',
	'imgwater_image_watermarktext_imskewx' => '文本水印横向倾斜角度(ImageMagick)',
	'imgwater_image_watermarktext_imskewx_tips' => '设置水印文本横向的倾斜角度。本设置只适用于 ImageMagick 图片处理库',
	'imgwater_image_watermarktext_imskewy' => '文本水印纵向倾斜角度(ImageMagick)',
	'imgwater_image_watermarktext_imskewy_tips' => '设置水印文本纵向的倾斜角度。本设置只适用于 ImageMagick 图片处理库',
